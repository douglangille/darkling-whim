...
I've voted NDP in every election for which I've been eligible save one. The first time I exercised by democratic right, I voted for Kim Campbell's Tories --- that worked out well.
...
Whether it's Proportional Representation, Alternative Voting, or some other scheme, it's got to be better than what we have now. I'm very curious as to the results of the [UK Referendum](http://en.wikipedia.org/wiki/2011_UK_referendum") on the topic.
